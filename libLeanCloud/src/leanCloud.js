...
!function (e) {
    if ("object" === ("undefined" == typeof exports ? "undefined" : _typeof(exports)) && "undefined" != typeof module)module.exports = e(); else if ("function" == typeof define && define.amd)define([], e); else {
        var t;
        t = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : this, t.AV = e()
    }
}(function () {
    var e;
    return function t(e, n, r) {
        ...
        7: [function (e, t, n) {
            !function (e) {
                ...
                r.length = 0, r.getItem = function (e) {
                    ...
                    i = {}, r.length = 0
                }, "object" === ("undefined" == typeof n ? "undefined" : _typeof(n)) ? t.exports = r : e.localStorageMemory = r
            }(this)
        }, {}],
        8: [function (e, t, n) {
            !function () {
                var n = e("crypt"), r = e("charenc").utf8, i = e("is-buffer"), s = e("charenc").bin, o = function a(e, t) {
                    e.constructor == String ? e = t && "binary" === t.encoding ? s.stringToBytes(e) : r.stringToBytes(e) : i(e) ? e = Array.prototype.slice.call(e, 0) : Array.isArray(e) || (e = e.toString());
                ...
                o._ff = function (e, t, n, r, i, s, o) {
                    ...
                    var a = e + (n ^ (t | ~r)) + (i >>> 0) + o;
                    return (a << s | a >>> 32 - s) + t
                }, o._blocksize = 16, o._digestsize = 16, t.exports = function (e, t) {
        ...
        }, {charenc: 9, crypt: 10, "is-buffer": 11}],
        9: [function (e, t, n) {
            var r = {
                utf8: {
            ...
            !function () {
                var e = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/", n = {
                    rotl: function (e, t) {
                        ...
                        for (var n = [], r = 0; r < t.length; r += 3)for (var i = t[r] << 16 | t[r + 1] << 8 | t[r + 2], s = 0; 4 > s; s++)8 * r + 6 * s <= 8 * t.length ? n.push(e.charAt(i >>> 6 * (3 - s) & 63)) : n.push("=");
                        return n.join("")
        ...
        13: [function (e, t, n) {
            ...
            function s(e, t, n) {
                ...
                if (g(n))for (var r in n)s(e, t + "[" + r + "]", n[r]); else e.push(encodeURIComponent(t) + "=" + encodeURIComponent(n))
            }
            ...
            var p, _ = e("emitter"), m = e("reduce"), v = e("./request-base"), g = e("./is-object");
            ...
            b.serializeObject = i, b.parseString = o, b.types = {
                html: "text/html",
            ...
            f.prototype.type = function (e) {
                ...
                var t = this, n = this.xhr = b.getXHR(), i = this._timeout, s = this._formData || this._data;
                ...
                if (i && !this._timer && (this._timer = setTimeout(function () {
                    ...
                    }, i)), this._appendQueryString(), this.username && this.password ? n.open(this.method, this.url, !0, this.username, this.password) : n.open(this.method, this.url, !0), this._withCredentials && (n.withCredentials = !0), "GET" != this.method && "HEAD" != this.method && "string" != typeof s && !this._isHost(s)) {
                    var c = this._header["content-type"], l = this._serializer || b.serialize[c ? c.split(";")[0] : ""];
                    !l && u(c) && (l = b.serialize["application/json"]), l && (s = l(s))
                }
        ...
        }, {"./is-object": 14, "./request": 16, "./request-base": 15, emitter: 3, reduce: 12}],
        14: [function (e, t, n) {
            function r(e) {
            ...
            (function () {
                function t(e) {
                    ...
                    return function (n, r, i, s) {
                        r = A(r, s, 4);
                        var o = !N(n) && w.keys(n), a = (o || n).length, u = e > 0 ? 0 : a - 1;
                ...
                function o(e, t) {
                    var n = P.length, r = e.constructor, i = w.isFunction(r) && r.prototype || l, s = "constructor";
                    for (w.has(e, s) && !w.contains(t, s) && t.push(s); n--;)s = P[n], s in e && e[s] !== i[s] && !w.contains(t, s) && t.push(s)
                }

                var a = this, u = a._, c = Array.prototype, l = Object.prototype, h = Function.prototype, f = c.push, d = c.slice, p = l.toString, _ = l.hasOwnProperty, m = Array.isArray, v = Object.keys, g = h.bind, b = Object.create, y = function () {
                }, w = function z(e) {
                ...
                var O = function (e, t) {
                    return function (n) {
                        ...
                        for (var i = 1; r > i; i++)for (var s = arguments[i], o = e(s), a = o.length, u = 0; a > u; u++) {
                            var c = o[u];
                ...
                }, j = Math.pow(2, 53) - 1, E = C("length"), N = function (e) {
                    var t = E(e);
                ...
                w.each = w.forEach = function (e, t, n) {
                    ...
                    return s
                }, w.reduce = w.foldl = w.inject = t(1), w.reduceRight = w.foldr = t(-1), w.find = w.detect = function (e, t, n) {
                    var r;
                    return r = N(e) ? w.findIndex(e, t, n) : w.findKey(e, t, n), void 0 !== r && -1 !== r ? e[r] : void 0
                    ...
                    if (null == t && null != e) {
                        e = N(e) ? e : w.values(e);
                        for (var a = 0, u = e.length; u > a; a++)r = e[a], r > s && (s = r)
                    ...
                    if (null == t && null != e) {
                        e = N(e) ? e : w.values(e);
                        for (var a = 0, u = e.length; u > a; a++)r = e[a], s > r && (s = r)
                    } else t = x(t, n), w.each(e, function (e, n, r) {
                        i = t(e, n, r), (o > i || i === 1 / 0 && s === 1 / 0) && (s = e, o = i)
                    });
                    return s
                ...
                w.groupBy = T(function (e, t, n) {
                    w.has(e, n) ? e[n].push(t) : e[n] = [t]
                }), w.indexBy = T(function (e, t, n) {
                    e[n] = t
                }), w.countBy = T(function (e, t, n) {
                    w.has(e, n) ? e[n]++ : e[n] = 1
                ...
                var U = function W(e, t, n, r) {
                    for (var i = [], s = 0, o = r || 0, a = E(e); a > o; o++) {
                        var u = e[o];
                        if (N(u) && (w.isArray(u) || w.isArguments(u))) {
                            t || (u = W(u, t, n));
                            var c = 0, l = u.length;
                ...
                w.flatten = function (e, t) {
                    ...
                    return n
                }, w.findIndex = i(1), w.findLastIndex = i(-1), w.sortedIndex = function (e, t, n, r) {
                    n = x(n, r, 1);
                    ...
                    return s
                }, w.indexOf = s(1, w.findIndex, w.sortedIndex), w.lastIndexOf = s(-1, w.findLastIndex), w.range = function (e, t, n) {
                ...
                w.bind = function (e, t) {
                    ...
                    var n = d.call(arguments, 2), r = function i() {
                        return R(e, i, t, this, n.concat(d.call(arguments)))
                    };
                    return r
                }, w.partial = function (e) {
                    var t = d.call(arguments, 1), n = function r() {
                    ...
                    var n = function r(n) {
                        var i = r.cache, s = "" + (t ? t.apply(this, arguments) : n);
                    ...
                    n || (n = {});
                    var u = function () {
                        a = n.leading === !1 ? 0 : w.now(), o = null, s = e.apply(r, i), o || (r = i = null)
                    };
                    return function () {
                        var c = w.now();
                        a || n.leading !== !1 || (a = c);
                        var l = t - (c - a);
                        return r = this, i = arguments, 0 >= l || l > t ? (o && (clearTimeout(o), o = null), a = c, s = e.apply(r, i), o || (r = i = null)) : o || n.trailing === !1 || (o = setTimeout(u, l)), s
                    }
                ...
                var I = !{toString: null}.propertyIsEnumerable("toString"), P = ["valueOf", "isPrototypeOf", "toString", "propertyIsEnumerable", "hasOwnProperty", "toLocaleString"];
                w.keys = function (e) {
                    if (!w.isObject(e))return [];
                    if (v)return v(e);
                    var t = [];
                    ...
                    t = x(t, n);
                    for (var r, i = w.keys(e), s = 0, o = i.length; o > s; s++)if (r = i[s], t(e[r], r, e))return r
                ...
                var k = function G(e, t, n, r) {
                    ...
                    if (n.push(e), r.push(t), s) {
                        ...
                        for (; u--;)if (!G(e[u], t[u], n, r))return !1
                    } else {
                        var c, l = w.keys(e);
                        if (u = l.length, w.keys(t).length !== u)return !1;
                        for (; u--;)if (c = l[u], !w.has(t, c) || !G(e[c], t[c], n, r))return !1
                    }
                ...
                w.isEqual = function (e, t) {
                    ...
                    return null == e ? !0 : N(e) && (w.isArray(e) || w.isString(e) || w.isArguments(e)) ? 0 === e.length : 0 === w.keys(e).length
                ...
                }), "function" != typeof/./ && "object" != ("undefined" == typeof Int8Array ? "undefined" : _typeof(Int8Array)) && (w.isFunction = function (e) {
                ...
                }, w.property = C, w.propertyOf = function (e) {
                ...
                w.mixin = function (e) {
                    w.each(w.functions(e), function (t) {
                        ...
                        w.prototype[t] = function () {
                            var e = [this._wrapped];
                            return f.apply(e, arguments), Q(this, n.apply(w, e))
                        }
                    })
                    ...
                    return "" + this._wrapped
                }, "function" == typeof e && e.amd && e("underscore", [], function () {
                    return w
                })
            }).call(this)
        }, {}],
        ...
        19: [function (e, t, n) {
            ...
            r.Error = function () {
                ...
                console.warn("AV.Error() is deprecated, and will be removed in next release."), new (Function.prototype.bind.apply(i, [null].concat(t)))
            }
        }, {
            "./acl": 18,
            "./cache": 22,
        ...
        20: [function (e, t, n) {
            (function (n) {
                var r = e("underscore"), i = e("../promise"), s = {}, o = ["getItem", "setItem", "removeItem", "clear"];
                if (n.localStorage) {
                    ...
                    r(o).each(function (e) {
                        s[e + "Async"] = function () {
                            return i.as(l[e].apply(l, arguments))
                        }
                    }), s.async = !0
                }
                t.exports = s
            }).call(this, "undefined" != typeof global ? global : "undefined" != typeof self ? self : "undefined" != typeof window ? window : {})
        }, {"../promise": 32, "localstorage-memory": 7, "react-native": 1, underscore: 17}],
        21: [function (e, t, n) {
            var r = function (e, t) {
                var n;
        ...
        22: [function (e, t, n) {
            var r = e("./localstorage"), i = e("./av"), s = n.remove = r.removeItemAsync.bind(r);
            n.get = function (e) {
            ...
            t.exports = function (e) {
                e.Cloud = e.Cloud || {}, r.extend(e.Cloud, {
                    run: function (t, n, r) {
                        ...
                        return o._thenRunCallbacks(n)
                    }
                })
            }
        }, {"./request": 36, underscore: 17}],
        24: [function (e, t, n) {
            function r(e, t) {
                ...
                e.Events = {
                    on: function (e, n, r) {
                        ...
                        if (s = this._callbacks) {
                            ...
                            for (e = e ? e.split(t) : _.keys(s), i = e.shift(); i;)if (o = s[i], delete s[i], o && (n || r)) {
        ...
        26: [function (e, t, n) {
            (function (n) {
                var r = e("underscore"), i = e("./uploader/cos"), s = e("./uploader/qiniu"), o = e("./error"), a = e("./request").request;
                t.exports = function (t) {
                    var u = t._config, c = function (e) {
                        ...
                        return t.length = Math.ceil(e.length / 3), r.times(t.length, function (n) {
                            var r = e[3 * n], i = e[3 * n + 1] || 0, s = e[3 * n + 2] || 0, o = 3 * n + 1 < e.length, a = 3 * n + 2 < e.length;
                            t[n] = [l(r >> 2 & 63), l(r << 4 & 48 | i >> 4 & 15), o ? l(i << 2 & 60 | s >> 6 & 3) : "=", a ? l(63 & s) : "="].join("")
                        }), t.join("")
                    }, f = function (e) {
                        ...
                        return s.onloadend = function () {
                            ...
                            var e = s.result, t = /^data:([^;]*);base64,(.*)$/.exec(e);
                            return t ? void i.resolve(t[2], r || t[1]) : void i.reject(new o(-1, "Unable to interpret data URL: " + e))
                        }, s.readAsDataURL(e), i
                    };
                    t.File = function (i, s, o) {
                        this.attributes = {name: i, url: "", metaData: {}, base64: ""};
                        var a = void 0;
                        if (s && s.owner)a = s.owner; else if (!t._config.disableCurrentUser)try {
                            a = t.User.current()
                        } catch (u) {
                        ...
                        toJSON: function () {
                            ...
                            return e instanceof t.ACL ? void(this._acl = e) : new o(o.OTHER_CAUSE, "ACL must be a AV.ACL.")
                        }, name: function () {
                            ...
                            switch (e) {
                                case"objectId":
                                    return this.id;
                                default:
                                    return void 0 === this.attributes[e] ? this.attributes.metaData[e] : this.attributes[e]
                            }
                        }, set: function m() {
                            var e = this, m = function (t, n) {
                                switch (t) {
                                    case"name":
                                    case"url":
                                    case"base64":
                            ...
                            switch (arguments.length) {
                                case 1:
                                    ...
                                    break;
                                case 2:
                                    m(arguments.length <= 0 ? void 0 : arguments[0], arguments.length <= 1 ? void 0 : arguments[1])
                            }
                            ...
                            var t = arguments.length <= 1 || void 0 === arguments[1] ? "fileTokens" : arguments[1], n = this.attributes.name, r = c(n), i = function () {
                            ...
                            return e && !this.attributes.metaData.mime_type && (this.attributes.metaData.mime_type = e), this._qiniu_key = s, a(t, null, null, "POST", o)
                        }, save: function () {
                            var e = this;
                            ...
                            if (!this._previousSave) {
                                ...
                                if (this._source && o)this._previousSave = this._source.then(function (t, n) {
                                ...
                                } else o || (this._previousSave = this._source.then(function (t, r) {
                                    var i = {
                                        base64: "",
                                        _ContentType: r,
                                        ACL: e._acl,
                                    ...
                                    return e.attributes.base64 ? (i.base64 = e.attributes.base64, a("files", e.attributes.name, null, "POST", i)) : "undefined" != typeof n.Buffer && n.Buffer.isBuffer(t) ? (i.base64 = t.toString("base64"), a("files", e.attributes.name, null, "POST", i)) : _(t).then(function (e) {
                                        return i.base64 = e, a("files", this.attributes.name, null, "POST", i)
                                    })
                                }).then(function (t) {
                                    return e.attributes.name = t.name, e.attributes.url = t.url, e.id = t.objectId, t.size && (e.attributes.metaData.size = t.size), e
                                }))
                            }
                            return this._previousSave._thenRunCallbacks(t)
                        }, fetch: function () {
                            var e = this, n = null, i = {};
                            ...
                            return s.then(function (n) {
                                ...
                                return i.attributes = {
                                    name: i.name,
                                    url: i.url
                                }, i.attributes.metaData = i.metaData || {}, delete i.objectId, delete i.metaData, delete i.url, delete i.name, r.extend(e, i), e
                            })._thenRunCallbacks(n)
                        }
                    }
                }
            ...
            "./browserify-wrapper/parse-base64": 21,
            "./error": 24,
            "./request": 36,
            "./uploader/cos": 40,
            "./uploader/qiniu": 41,
            ...
            t.exports = function (e) {
                e.GeoPoint = function (t, n) {
                    ...
                    toJSON: function () {
                        ...
                        var t = Math.PI / 180, n = this.latitude * t, r = this.longitude * t, i = e.latitude * t, s = e.longitude * t, o = n - i, a = r - s, u = Math.sin(o / 2), c = Math.sin(a / 2), l = u * u + Math.cos(n) * Math.cos(i) * c * c;
        ...
        28: [function (e, t, n) {
            var r = e("underscore"), i = e("./error"), s = e("./request").request;
            t.exports = function (e) {
                e.Insight = e.Insight || {}, r.extend(e.Insight, {
                    ...
                    skip: function (e) {
                        ...
                        var n = {skip: this._skip, limit: this._limit}, r = s("bigquery", "jobs", this.id, "GET", n);
                        return r.then(function (t) {
                            return t.error ? e.Promise.error(new i(t.code, t.error)) : e.Promise.as(t)
                        })._thenRunCallbacks(t)
                    }
                }
            }
        ...
        29: [function (e, t, n) {
            var r = e("underscore"), i = e("./promise"), s = e("./browserify-wrapper/localStorage"), o = ["getItem", "setItem", "removeItem", "clear"];
            s.async ? r(o).each(function (e) {
                "function" != typeof s[e] && (s[e] = function () {
                    throw new Error("Synchronous API [" + e + "] is not available in this runtime.")
                })
            }) : r(o).each(function (e) {
                "function" == typeof s[e] && (s[e + "Async"] = function () {
                    return i.as(s[e].apply(s, arguments))
                })
            }), t.exports = s
        }, {"./browserify-wrapper/localStorage": 20, "./promise": 32, underscore: 17}],
        30: [function (e, t, n) {
            var r = e("underscore"), i = e("./error"), s = e("./request").request, o = e("./utils");
            t.exports = function (e) {
                    ...
                    _fetchWhenSave: !1, initialize: function () {
                        ...
                        switch (e) {
                            case"objectId":
                                return this.id;
                            default:
                                return void 0 === this.attributes[e] ? this[e] : this.attributes[e]
                        }
                    }, relation: function (t) {
                        var n = this.get(t);
                        if (n) {
                        ...
                        var s;
                        if (r.isObject(t) || o.isNullOrUndefined(t) ? (s = t, e._objectEach(s, function (t, n) {
                                s[n] = e._decode(n, t)
                            }), i = n) : (s = {}, s[t] = e._decode(t, n)), i = i || {}, !s)return this;
                        s instanceof e.Object && (s = s.attributes), i.unset && e._objectEach(s, function (t, n) {
                            s[n] = new e.Op.Unset
                        });
                        var a = r.clone(s), u = this;
                        if (e._objectEach(a, function (t, n) {
                                t instanceof e.Op && (a[n] = t._estimate(u.attributes[n], u, n), a[n] === e.Op._UNSET && delete a[n])
                        ...
                        return e._arrayEach(r.keys(s), function (t) {
                            ...
                            a[t] = n._mergeWithPrevious(a[t]), u._rebuildEstimatedDataForKey(t), o ? (u.changed[t] = u.attributes[t], i.silent || (u._pending[t] = !0)) : (delete u.changed[t], delete u._pending[t])
                        ...
                        var n = this, i = s("classes", this.className, this.id, "GET", t, e.sessionToken);
                        ...
                        f.wait && (f.silent = !0);
                        var d;
                        if (f.error = function (e, t) {
                                d = t
                            }, a && !this.set(a, f))return e.Promise.error(d)._thenRunCallbacks(c, this);
                        var p = this;
                        p._refreshCache();
                        var _ = [], m = [];
                        return e.Object._findUnsavedChildren(p.attributes, _, m), _.length + m.length > 0 ? e.Object._deepSaveAsync(this.attributes, p, c).then(function () {
                            return p.save(null, c)
                        }, function (t) {
                            return e.Promise.error(t)._thenRunCallbacks(c, p)
                            ...
                            var t = p.id ? "PUT" : "POST", n = p._getSaveJSON();
                            ...
                            var l = "classes", h = p.className;
                            "_User" !== p.className || p.id || (l = "users", h = null);
                            var d = c._makeRequest || s, _ = d(l, h, p.id, t, n, c.sessionToken);
                            return _ = _.then(function (e) {
                                var t = p.parse(e);
                                return c.wait && (t = r.extend(a || {}, t)), p._finishSave(t), c.wait && p.set(u, f), p
                            }, function (t) {
                                return p._cancelSave(), e.Promise.error(t)
                            })._thenRunCallbacks(c, p)
                        ...
                        return console.warn("AV.Object.prototype.existed() is deprecated."), !1
                        ...
                        return !r.has(t, "ACL") || t.ACL instanceof e.ACL ? !1 : new i(i.OTHER_CAUSE, "ACL must be a AV.ACL.")
                    ...
                    return c.then(function () {
                        return e.Promise._continueWhile(function () {
                            ...
                            if (e._arrayEach(h, function (e) {
                                ...
                                }), h = n, 0 === t.length)return e.Promise.error(new i(i.OTHER_CAUSE, "Tried to save a batch with a cycle."));
                            ...
                            return e._arrayEach(t, function (e) {
                                ...
                                }, o && o.sessionToken).then(function (n) {
                                    var r;
                                    return e._arrayEach(t, function (e, t) {
                                        n[t].success ? e._finishSave(e.parse(n[t].success)) : (r = r || n[t].error, e._cancelSave())
                                    }), r ? e.Promise.error(new i(r.code, r.error)) : void 0
                                }).then(function (e) {
                                    return u.resolve(e), e
                                }, function (t) {
                                    return u.reject(t), e.Promise.error(t)
                                })
                            })
                        })
                    }).then(function () {
        ...
        32: [function (e, t, n) {
            (function (n) {
                ...
                "undefined" != typeof n && n.versions && n.versions.node && (o = !0), r.extend(i, {
                    _isPromisesAPlusCompliant: !o,
                    _debugError: !1,
                    ...
                    as: function () {
                        var e = new i;
                        return arguments[0] && r.isFunction(arguments[0].then) ? arguments[0].then(function (t) {
                            e.resolve.call(e, t)
                        }, function (t) {
                            e.reject.call(e, t)
                        }) : e.resolve.apply(e, arguments), e
                    },
                    error: function () {
                        var e = new i;
                    ...
                    race: function (e) {
                        var t;
                        t = e && s(e.length) ? arguments : e;
                        var n = t.length, o = !1, a = [], u = [];
                        if (a.length = u.length = t.length, 0 === n)return i.as.call(this);
                        var c = new i, l = function (e) {
                            c._resolved || c._rejected || (o ? c.reject.call(c, u[e]) : c.resolve.call(c, a[e]))
                        };
                        return r.each(t, function (e, t) {
                            i.is(e) ? e.then(function (e) {
                                a[t] = e, l(t)
                    ...
                    resolve: function (e) {
                        ...
                        return this._resolved ? u(function () {
                            ...
                            a.apply(c, [c._error])
                        }) : (this._resolvedCallbacks.push(o), this._rejectedCallbacks.push(a)), s
                    }, "catch": function (e) {
        ...
        36: [function (e, t, n) {
            (function (n) {
                var r = e("superagent"), i = e("debug")("request"), s = e("md5"), o = e("./promise"), a = e("./cache"), u = e("./error"), c = e("./av"), l = function (e, t) {
                    ...
                    var s = arguments.length <= 3 || void 0 === arguments[3] ? {} : arguments[3], a = arguments[4];
                    i(e, t, n, s);
                    var u = new o, c = r(e, t).set(s).send(n).end(function (e, t) {
                    ...
                    var r = new o;
                    return e ? (t["X-LC-Session"] = e, r.resolve(t)) : c._config.disableCurrentUser ? r.resolve(t) : c.User.currentAsync().then(function (e) {
                        e && e._sessionToken && (t["X-LC-Session"] = e._sessionToken), r.resolve(t)
                    }), r
                }, p = function (e, t, n, r, i) {
                    c.serverURL && (c._config.APIServerURL = c.serverURL, console.warn("Please use AV._config.APIServerURL to replace AV.serverURL, and it is an internal interface."));
                    var s = c._config.APIServerURL;
                    if ("/" !== s.charAt(s.length - 1) && (s += "/"), s += "1.1/" + e, t && (s += "/" + t), n && (s += "/" + n), "users" !== e && "classes" !== e || !i || (s += "?", i._fetchWhenSave && (delete i._fetchWhenSave, s += "&new=true"), i._where && (s += "&where=" + encodeURIComponent(JSON.stringify(i._where)), delete i._where)), "get" === r.toLowerCase()) {
                        -1 === s.indexOf("?") && (s += "?");
                        for (var o in i)"object" === _typeof(i[o]) && (i[o] = JSON.stringify(i[o])), s += "&" + o + "=" + encodeURIComponent(i[o])
                    }
                    return s
                }, _ = function (e, t) {
                    "number" != typeof t && (t = 3600), a.set("APIServerURL", e, 1e3 * t)
                }, m = function (e) {
                    var t = new o;
                    if (410 === e.statusCode)_(e.response.api_server, e.response.ttl), t.resolve(e.response.location); else {
                        var n = {code: -1, error: e.responseText};
                        if (e.response && e.response.code)n = e.response; else if (e.responseText)try {
                    ...
                    var e = arguments.length <= 0 || void 0 === arguments[0] ? "cn" : arguments[0], t = {
                    ...
                    n.region = e, n.APIServerURL || (n.APIServerURL = t[e], "cn" === e && a.get("APIServerURL").then(function (e) {
                        return e ? e : f("get", "https://app-router.leancloud.cn/1/route?appId=" + c.applicationId).then(function (e) {
                            return e.api_server ? (_(e.api_server, e.ttl), e.api_server) : void 0
                        })
                    }).then(function (r) {
                        n.APIServerURL === t[e] && (n.APIServerURL = "https://" + r)
                    }))
                }, g = function (e, t, n, r) {
                ...
                t.exports = {ajax: f, request: g, setServerUrlByRegion: v}
            }).call(this, e("_process"))
        }, {"./av": 19, "./cache": 22, "./error": 24, "./promise": 32, _process: 2, debug: 4, md5: 8, superagent: 13}],
        37: [function (e, t, n) {
        ...
        38: [function (e, t, n) {
            ...
            t.exports = function (e) {
                e.SearchSortBuilder = function () {
                    ...
                    _sortBuilder: null,
                    _createRequest: function (e, t) {
                        return i("search/select", null, null, "GET", e || this.toJSON(), t && t.sessionToken)
                    },
                    sid: function (e) {
        ...
        39: [function (e, t, n) {
            ...
            t.exports = function (e) {
                e.Status = function (e, t) {
                    return this.data = {}, this.inboxType = "default", this.query = null, e && "object" === ("undefined" == typeof e ? "undefined" : _typeof(e)) ? this.data = e : (e && (this.data.image = e), t && (this.data.message = t)), this
                }, e.Status.prototype = {
                    get: function (e) {
                        return this.data[e]
                    }, set: function (e, t) {
                        ...
                        var o = i("statuses", null, null, "POST", r, t && t.sessionToken), a = this;
                ...
                }, e.Status.sendPrivateStatus = function (t, n, s) {
                    if (!e.User.current())throw"Please signin an user.";
                    ...
                    t = t || e.User.current();
                    var n = r.isString(arguments[1]) ? arguments[2] : arguments[1], s = r.isString(arguments[1]) ? arguments[1] : "default", o = {};
        ...
        40: [function (e, t, n) {
            var r = e("superagent"), i = e("debug")("cos"), s = e("../promise");
            t.exports = function (e, t, n) {
                var o = arguments.length <= 3 || void 0 === arguments[3] ? {} : arguments[3];
                n.attributes.url = e.url, n._bucket = e.bucket, n.id = e.objectId;
                var a = e.upload_url + "?sign=" + encodeURIComponent(e.token), u = new s, c = r("POST", a).field("fileContent", t).field("op", "upload").end(function (e, t) {
                ...
                return o.onprogress && c.on("progress", o.onprogress), u
            }
        }, {"../promise": 32, debug: 4, superagent: 13}],
        41: [function (e, t, n) {
            var r = e("superagent"), i = e("../promise"), s = e("debug")("qiniu");
            t.exports = function (e, t, n) {
                var o = arguments.length <= 3 || void 0 === arguments[3] ? {} : arguments[3];
                n.attributes.url = e.url, n._bucket = e.bucket, n.id = e.objectId;
                var a = e.token, u = new i, c = r("POST", "https://up.qbox.me").field("file", t).field("name", n.attributes.name).field("key", n._qiniu_key).field("token", a).end(function (e, t) {
        ...
        42: [function (e, t, n) {
            ...
            var i = e("underscore"), s = e("./error"), o = e("./request").request;
            t.exports = function (e) {
                e.User = e.Object.extend("_User", {
                    _isCurrentUser: !1, _mergeMagicFields: function (t) {
                        ...
                        return t && !e._config.disableCurrentUser && (this._isCurrentUser = !0), this._cleanupAuthData(), this._synchronizeAllAuthData(), delete this._serverData.password, this._rebuildEstimatedDataForKey("password"), this._refreshCache(), !t && !this.isCurrent() || e._config.disableCurrentUser ? e.Promise.as() : e.Promise.as(e.User._saveCurrentUser(this))
                        ...
                        var a = this, u = new e.Promise;
                        return t.authenticate({
                            success: function (e, t) {
                                a._linkWith(e, {authData: t, success: n.success, error: n.error}).then(function () {
                                    u.resolve(a)
                                })
                            }, error: function (e, t) {
                                n.error && n.error(a, t), u.reject(t)
                            }
                        }), u
                    }, _unlinkFrom: function (t, n) {
                        var r;
                        i.isString(t) ? (r = t, t = e.User._authProviders[t]) : r = t.getAuthType();
                        var s = i.clone(n), o = this;
                        return s.authData = null, s.success = function (e) {
                            o._synchronizeAuthData(t), n.success && n.success.apply(this, arguments)
                        }, this._linkWith(t, s)
                    ...
                    }, signUpOrlogInWithMobilePhone: function (e, t) {
                        var n;
                        t = t || {};
                        ...
                        if (!n)throw"Invalid target user.";
                        var r = "users/" + this.id + "/friendship/" + n, s = o(r, null, null, "POST", null, t && t.sessionToken);
                        return s._thenRunCallbacks(t)
                    }, unfollow: function (e, t) {
                        if (!this.id)throw"Please signin.";
                        if (!e)throw"Invalid target user.";
                        var n = i.isString(e) ? e : e.id;
                        if (!n)throw"Invalid target user.";
                        var r = "users/" + this.id + "/friendship/" + n, s = o(r, null, null, "DELETE", null, t && t.sessionToken);
                        return s._thenRunCallbacks(t)
                        ...
                        return s._thenRunCallbacks(n, this)
                    }, isCurrent: function () {
                        ...
                        return !!this._sessionToken && !e._config.disableCurrentUser && e.User.current() && e.User.current().id === this.id
                    ...
                    signUpOrlogInWithAuthData: function (t, n, r) {
                        return e.User._logInWith(n, {
                            authData: t, success: function (e) {
                                r.success(e)
                            }, error: function (e) {
                                r.error(e)
                            }
                    ...
                    requestPasswordReset: function (e, t) {
                        var n = {email: e}, r = o("requestPasswordReset", null, null, "POST", n);
                        return r._thenRunCallbacks(t)
                    },
                    requestEmailVerify: function (e, t) {
                        var n = {email: e}, r = o("requestEmailVerify", null, null, "POST", n);
                        return r._thenRunCallbacks(t)
                    },
                    requestEmailVerfiy: function (e, t) {
                        var n = {email: e}, r = o("requestEmailVerify", null, null, "POST", n);
                        return r._thenRunCallbacks(t)
                    },
                    requestMobilePhoneVerify: function (e, t) {
                        var n = {mobilePhoneNumber: e}, r = o("requestMobilePhoneVerify", null, null, "POST", n);
                        return r._thenRunCallbacks(t)
                    },
                    requestPasswordResetBySmsCode: function (e, t) {
                        var n = {mobilePhoneNumber: e}, r = o("requestPasswordResetBySmsCode", null, null, "POST", n);
                        return r._thenRunCallbacks(t)
                    },
                    resetPasswordBySmsCode: function (e, t, n) {
                        var r = {password: t}, i = o("resetPasswordBySmsCode", null, e, "PUT", r);
                        return i._thenRunCallbacks(n)
                    },
                    verifyMobilePhone: function (e, t) {
                        var n = o("verifyMobilePhone", null, e, "POST", null);
                        return n._thenRunCallbacks(t)
                    },
                    requestLoginSmsCode: function (e, t) {
                        var n = {mobilePhoneNumber: e}, r = o("requestLoginSmsCode", null, null, "POST", n);
                        return r._thenRunCallbacks(t)
                    },
                    ...
                    _saveCurrentUser: function (t) {
                        var n;
                        return n = e.User._currentUser !== t ? e.User.logOut() : e.Promise.as(), n.then(function () {
        ...
        43: [function (e, t, n) {
            (function (n) {
                var r = e("underscore"), i = e("./request"), s = function (e) {
                    return r.isNull(e) || r.isUndefined(e)
                }, o = function (e) {
                    var t = e._config;
                    r.extend(t, {
                    ...
                    }), "undefined" != typeof n && n.versions && n.versions.node && (t.isNode = !0);
                    var o = function () {
                    }, a = function (e, t, n) {
                        var i;
                        return i = t && t.hasOwnProperty("constructor") ? t.constructor : function () {
                            e.apply(this, arguments)
                        }, r.extend(i, e), o.prototype = e.prototype, i.prototype = new o, t && r.extend(i.prototype, t), n && r.extend(i, n), i.prototype.constructor = i, i.__super__ = e.prototype, i
                    }, u = function (t, n, r) {
                        e.applicationId && t !== e.applicationId && n !== e.applicationKey && r !== e.masterKey && console.warn("LeanCloud SDK is already initialized, please do not reinitialize it."), e.applicationId = t, e.applicationKey = n, e.masterKey = r, e._useMasterKey = !1
                    };
                    e.init = function () {
                        var e = function () {
                        ...
                        switch (arguments.length) {
                            case 1:
                                ...
                                if ("object" !== ("undefined" == typeof n ? "undefined" : _typeof(n)))throw new Error("AV.init(): Parameter is not correct.");
                                !t.isNode && n.masterKey && e(), u(n.appId, n.appKey, n.masterKey), i.setServerUrlByRegion(n.region), t.disableCurrentUser = n.disableCurrentUser;
                                break;
                            case 2:
                            case 3:
                                console.warn("Please use AV.init() to replace AV.initialize() ."), t.isNode || 3 !== arguments.length || e(), u.apply(void 0, arguments), i.setServerUrlByRegion("cn")
                        }
                    }, t.isNode && (e.Cloud = e.Cloud || {}, e.Cloud.useMasterKey = function () {
                        e._useMasterKey = !0
                    }), e.initialize = e.init, e.setProduction = function (e) {
                        s(e) ? t.applicationProduction = null : t.applicationProduction = e ? 1 : 0
                    }, e.useAVCloudCN = function () {
                        i.setServerUrlByRegion("cn"), console.warn("Do not use AV.useAVCloudCN. Please use AV.init(), you can set the region of server.")
                    }, e.useAVCloudUS = function () {
                        i.setServerUrlByRegion("us"), console.warn("Do not use AV.useAVCloudUS. Please use AV.init(), you can set the region of server.")
                        ...
                        return e.localStorage.getItemAsync(t).then(function (n) {
                            ...
                            return e._installationId = r() + r() + "-" + r() + "-" + r() + "-" + r() + "-" + r() + r() + r(), e.localStorage.setItemAsync(t, e._installationId)
                        })
                        ...
                        console.warn("AV._ajax is deprecated, and will be removed in next release."), i.ajax.apply(i, arguments)
                    }, e._request = function () {
                        console.warn("AV._request is deprecated, and will be removed in next release."), i.request.apply(i, arguments)
                    }, e._extend = function (e, t) {
                        var n = a(this, e, t);
                        return n.extend = this.extend, n
                    }, e._getValue = function (e, t) {
                        ...
                        if ("Object" === n.__type) {
                            i = n.className, delete n.__type, delete n.className;
                        ...
                        if ("File" === n.__type) {
                            ...
                            return u.attributes.metaData = n.metaData || {}, u.attributes.url = n.url, u.id = n.objectId, u
                        }
                    ...
                    }, e._arrayEach = r.each, e._traverse = function (t, n, i) {
                        if (t instanceof e.Object) {
                        ...
                        return t instanceof e.Relation || t instanceof e.File ? n(t) : r.isArray(t) ? (r.each(t, function (r, s) {
                            ...
                            o && (t[s] = o)
                        }), n(t)) : r.isObject(t) ? (e._each(t, function (r, s) {
                            var o = e._traverse(r, n, i);
                            o && (t[s] = o)
                        }), n(t)) : n(t)
                    }, e._objectEach = e._each = function (e, t) {
