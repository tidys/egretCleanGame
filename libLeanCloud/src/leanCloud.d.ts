...
declare module AV {
    ...
    class Object extends BaseObject {
        ...
        static destroyAll<T>(list: Object[], options?): Promise<T>;
        static saveAll<T>(list: Object[], options?): Promise<T>;
        ...
        clone(): Object;
        destroy<T>(options?): Promise<T>;
        dirty(attr: String): boolean;
        dirtyKeys(): string[];
        escape(attr: string): string;
        existed(): boolean;
        fetch<T>(fetchOptions?:any,options?): Promise<T>;
        ...
        save<T>(options?, arg2?: any, arg3?: any): Promise<T>;
    ...
    class Collection<T> extends Events implements IBaseObject {
        ...
        constructor(models?: Object[], options?);
        static extend(instanceProps: any, classProps: any): any;

        initialize(): void;
        add(models: any[], options?): Collection<T>;
        at(index: number): Object;
        fetch(options?): Promise<T>;
        create(model: Object, options?): Object;
        get(id: string): Object;
        getByCid(cid: any): any;
        pluck(attr: string): any[];
        remove(model: any, options?): Collection<T>;
        remove(models: any[], options?): Collection<T>;
        reset(models: any[], options?): Collection<T>;
        sort(options?): Collection<T>;
        toJSON(): any;
    }
    ...
    class Query extends BaseObject {
        ...
        static doCloudQuery<T>(cql:string,pvalues?:any,options?):Promise<T>;
        ...
        find<T>(options?): Promise<T>;
        first<T>(options?): Promise<T>;
        get<T>(objectId: string, options?): Promise<T>;
